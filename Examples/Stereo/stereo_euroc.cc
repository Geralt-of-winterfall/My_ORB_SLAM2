...
int main(int argc, char **argv)
{
    ...
    for(int ni=0; ni<nImages; ni++)
    {
        ...
        //detector->detect(imDetect, results);
    ...
    for(int ni=0; ni<nImages; ni++)
    {
        totalDtime+=vTimesDetect[ni];
    }
    cout << "-------" << endl << endl;
    cout << "median Detect time: " << vTimesDetect[nImages/2] << endl;
    cout << "mean Detect time: " << totalDtime/nImages << endl;
    **/
